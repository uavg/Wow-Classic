...
local function ColorHealthbarOnThreat(self,unit)
  -- classic-disable
  if self.colorThreat and self.colorThreatInvers and unit then --and UnitThreatSituation("player", unit) == 3 then
  ...
  elseif self.colorThreat and unit then --and UnitThreatSituation(unit) == 3 then
